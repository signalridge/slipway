...
- [アイデアから Run までのワークフロー](guides/idea-to-run-workflow.md) — rough idea、Objective、Change、既存 Run を、ユーザーが所有する Slipway function boundary に沿って最短 route へ案内します。
...
- [Acceptance suite](../../acceptance/README.md) — 実行可能/手動の動作確認。
