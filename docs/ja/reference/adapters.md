...
![Slipway ホストアダプター: install が10個の対応host向けnative entry pointを書き込み、各entryが同じ6個のexplicit capabilityを公開し、versioned JSONでlocal CLIへrouteする。](../../assets/diagrams/tool-adapters.svg)
