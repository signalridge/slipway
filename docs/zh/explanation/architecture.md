...
Source Bundle 的设计理由与被拒方案记录在 [ADR-0001](../../../adr/0001-source-bundle-v2.md)。issue #434 的基础契约、后续 Accepted ADR 与版本化 schema 共同定义预期契约；[ADR-0002](../../../adr/0002-seventh-capability-workflow.md) 对 issue 中所有精确“六能力”陈述做窄范围 supersession，并重申不引入 router 的边界。Runtime test 是当前实现行为的可执行证据，不能替代这些依据。
