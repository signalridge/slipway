...
evidence is recorded through `slipway evidence task` under
`.git/slipway/runtime/changes/<slug>/evidence/`. It does not generate any
AI-tool surfaces unless you pass `--tools`:
