...
The complete Chinese contract in [issue #434](https://github.com/signalridge/slipway/issues/434) and the [versioned machine schema](../docs/reference/v2/machine-protocol.schema.json) define the intended contract. Implementation exposes current behavior, while tests and [`acceptance/`](../acceptance/README.md) record observations rather than readiness or release authority. User-facing behavior belongs under [`docs/`](../docs/en/index.md).
