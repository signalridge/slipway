...
Current behavior must still be verified against implementation, tests, and versioned schemas. User-facing behavior belongs under [`docs/`](../docs/en/index.md), and executable evidence belongs under [`acceptance/`](../acceptance/README.md).
