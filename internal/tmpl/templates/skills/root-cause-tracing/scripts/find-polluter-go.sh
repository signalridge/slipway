...
#
# Forked from superpowers/systematic-debugging/find-polluter.sh and
# specialized for Go's `go test` invocation. The original npm-oriented
# variant is preserved upstream.
#
# Usage:
