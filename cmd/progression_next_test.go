...
func TestNextGovernedBlocksWithoutTaskEvidenceForWaveRunSummaryDuringImplementation(t *testing.T) {
	...
	assert.Contains(t, missingEvidenceBlocker, "result_schema=task_id,verdict,evidence_ref,changed_files,no_op_justification,blockers,session_id")
...
func assertSingleRunSummaryMissingTaskEvidenceBlocker(t *testing.T, surface string, blockers []model.ReasonCode, slug string) {
	...
	assert.Contains(t, missingEvidenceBlocker, "result_schema=task_id,verdict,evidence_ref,changed_files,no_op_justification,blockers,session_id", surface)
