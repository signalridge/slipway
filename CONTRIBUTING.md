...
Thanks for improving Slipway. Keep pull requests focused, use a fork when you don't have write access, and keep implementation, tests, generated capability contracts, and documentation aligned.
