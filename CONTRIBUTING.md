...
See [architecture](docs/explanation/architecture.md), [machine protocol](docs/reference/machine-protocol.md), and [acceptance scenarios](docs/acceptance/scenarios/README.md).
