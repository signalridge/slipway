...
- [x] `task-001` Author the Part A + Part C template-content contract tests (RED)
  - wave: 1
  - depends_on: []
...
- [x] `task-002` Register `test-design` atomically: registry + templates + references + allowlist + fixtures (GREEN for Part A)
  - wave: 2
  - depends_on: [task-001]
...
- [x] `task-003` Encode Part C test/implementation isolation in the host templates (GREEN for Part C)
  - wave: 2
  - depends_on: [task-001]
...
- [x] `task-004` Author the Part B language-hint tests against the frozen public API (RED)
  - wave: 3
  - depends_on: [task-002]
...
- [x] `task-005` Implement the Part B schema + per-language emitter to satisfy the frozen tests (GREEN)
  - wave: 4
  - depends_on: [task-004]
...
- [x] `task-006` Document the capability:language-testing host-resolution contract
  - wave: 5
  - depends_on: [task-005]
...
- [x] `task-007` Final build and full test-suite verification
  - wave: 5
