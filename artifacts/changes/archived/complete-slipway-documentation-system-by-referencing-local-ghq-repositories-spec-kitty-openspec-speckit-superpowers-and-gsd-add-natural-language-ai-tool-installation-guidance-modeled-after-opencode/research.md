...
- `/Users/yixianlu/ghq/github.com/Priivacy-ai/spec-kitty/docs/index.md` for Divio-style docs categories and docs verification notes.
- `/Users/yixianlu/ghq/github.com/Priivacy-ai/spec-kitty/docs/reference/supported-agents.md` and `/Users/yixianlu/ghq/github.com/Priivacy-ai/spec-kitty/docs/how-to/harnesses/opencode.md` for AI harness directory and OpenCode setup patterns.
- `/Users/yixianlu/ghq/github.com/Fission-AI/OpenSpec/docs/supported-tools.md` and `/Users/yixianlu/ghq/github.com/Fission-AI/OpenSpec/docs/workflows.md` for tool matrices and workflow documentation patterns.
- `/Users/yixianlu/ghq/github.com/github/spec-kit/docs/installation.md` and `/Users/yixianlu/ghq/github.com/github/spec-kit/docs/reference/integrations.md` for install and integration safety patterns.
- `/Users/yixianlu/ghq/github.com/obra/superpowers/README.md` and `/Users/yixianlu/ghq/github.com/obra/superpowers/docs/README.opencode.md` for natural-language OpenCode installation guidance.
- `/Users/yixianlu/ghq/github.com/gsd-build/get-shit-done/docs/README.md`, `/Users/yixianlu/ghq/github.com/gsd-build/get-shit-done/docs/COMMANDS.md`, and `/Users/yixianlu/ghq/github.com/gsd-build/get-shit-done/docs/USER-GUIDE.md` for audience-indexed docs and runtime-specific command syntax.
- `/Users/yixianlu/ghq/github.com/anomalyco/opencode/README.md` and `/Users/yixianlu/ghq/github.com/opencode-ai/opencode/README.md` for OpenCode install and project command path behavior.
